...
//                        System.out.println(requestWrapper.getRequest());
...
//            }
    ...
    private <T extends HttpRequest> T withAuthInfo(T request, String path, long customerId,
        String apiKey, String secretKey) throws SignatureException {
        ...
        return (T) request
            ...
            .header("X-Signature",
                Signatures.of(timestamp, request.getHttpMethod().name(), path, secretKey));
    }
